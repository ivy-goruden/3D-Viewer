...
class ApplicationPath {
   ...
   public:
    ...
    fs::path get_executable_path() const { return executable_path; }

    // Получить директорию исполняемого файла
    fs::path get_executable_dir() const { return executable_dir; }

    // Получить текущую рабочую директорию
    fs::path get_current_work_dir() const { return current_work_dir; }
