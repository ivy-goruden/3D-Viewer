...
Controller::~Controller() { delete figure_; }

double Controller::getAngleX() { return angleX_; }

double Controller::getAngleY() { return angleY_; }

double Controller::getAngleZ() { return angleZ_; }

void Controller::setAngleX(int angle) { angleX_ = angle; }

void Controller::setAngleY(int angle) { angleY_ = angle; }

void Controller::setAngleZ(int angle) { angleZ_ = angle; }

void Controller::setCamera(int camera) { camera_ = camera; }

double Controller::getScale() { return scale_; }

int Controller::getZoom() { return camera_; }

void Controller::shiftX(int shiftx) { shiftx_ = shiftx; }

void Controller::shiftY(int shifty) { shifty_ = shifty; }
...
void Controller::setScale(double scale) { scale_ = scale; }
